...
const FastPathCache = struct {
    ...
    cache_entries: std.HashMap(usize, CacheEntry, void, std.hash_map.default_max_load_percentage),
    ...
    pub fn init(allocator: std.mem.Allocator) !FastPathCache {
        return FastPathCache{
            .allocator = allocator,
            .cache_entries = std.HashMap(usize, CacheEntry, void, std.hash_map.default_max_load_percentage).init(allocator),
        };
    }
...
const PredictiveAllocator = struct {
    allocator: std.mem.Allocator,
    enabled: bool,
    prediction_cache: std.HashMap(u32, PredictionEntry, void, std.hash_map.default_max_load_percentage), // Keyed by PID
    ...
    pub fn init(allocator: std.mem.Allocator) !PredictiveAllocator {
        return PredictiveAllocator{
            .allocator = allocator,
            .enabled = false,
            .prediction_cache = std.HashMap(u32, PredictionEntry, void, std.hash_map.default_max_load_percentage).init(allocator),
        };
    }
